        ...
        <div class="bg-orange-500 p-10 flex flex-col justify-center w-full md:w-3/5">
            ...
            <form method="POST" action="{{ route('register.proccess') }}">
                ...
                <div class="flex gap-2">
                    <a href="{{route('login')}}" class="w-full py-2 px-4 text-center bg-yellow-500 text-white rounded-md shadow-lg hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">Login</a>
                    <button type="submit" class="w-full py-2 px-4 bg-teal-800 text-white rounded-md shadow-lg hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">Buat Akun</button>
                </div>
            </form>
        </div>
